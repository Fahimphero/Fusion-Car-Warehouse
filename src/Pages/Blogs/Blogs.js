                        ...
                        <Accordion>
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body >
                                    ...
                                    Javascript is a scripted programming language which can run in any browser. Chrome uses its V8 engine to run javascript's code. It can run in any web browser with a proper browser engine. JavaScript is mainly used for any client-side activity for a web application.
                            ...
                            <Accordion.Item eventKey="1">
                                ...
                                <Accordion.Body>
                                    ...
                                    MonogDB is a database system which gives us a chance to efficiently store documents in a database and to perform operations like data update, delete or to search documents by some criterias. We primarily use Mongodb to store data.
                                    Nodejs is used in server-side development. NodeJs recieves the request from the client side and completes the operation.Node.js can add, delete, modify data in our database. NodeJs is a server which connects the client side with the database.
                                </Accordion.Body>
                            </Accordion.Item>
